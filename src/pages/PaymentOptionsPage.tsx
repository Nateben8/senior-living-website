    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <a href="https://www.whereyoulivematters.org" target="_blank" rel="noopener noreferrer" className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-colors text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Where You Live Matters</h3>
              <p className="text-sm text-gray-600">Information about senior living options and community resources</p>
            </a>
            <a href="https://www.aarp.org" target="_blank" rel="noopener noreferrer" className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-colors text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">AARP</h3>
              <p className="text-sm text-gray-600">Advocacy and resources for seniors and their families</p>
            </a>
